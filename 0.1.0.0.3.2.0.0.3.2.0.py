# Let's keep going with even more skills and adaptations.
...
# Let's continue to experiment with new skills and see what else we can learn!
...
# Let's add another skill to our repertoire - carpentry
def carpentry():
