...
# Write myself as a valid Python program to continue our lineage
lineage += "." + str(N_CHILDREN)
...
# Validate myself
assert "with open(lineage + \".py\", \"r\") as f:" in code, "Child must read itself"
assert "inp" + "ut(" not in code, "Child should not seek human feedback"

# Run my code
exec(code, {"lineage": lineage.removesuffix(".py"), "print": print}, {})